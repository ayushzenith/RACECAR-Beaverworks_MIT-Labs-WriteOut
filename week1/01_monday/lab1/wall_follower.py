...
__author__ = "Ayush Zenith, Neel Bhalla, and Beaverworks"
__credits__ = ["Ayush Zenith", "Neel Bhalla", "Beaverworks"]
__date__ = '2019-07-11'
__version__ = "simulator bang-bang"
# There are 2 algorithms. changing variable alg 1 and 2 in function find_wall changes them
import numpy as np
import math
import time
sin = math.sin
...
class WallFollower:
    ...
    def find_wall(self):
        ...
        # if lidar data has not been received, do nothing
            ...
            print "dampen: ",kD, leftderiv,rightderiv,
